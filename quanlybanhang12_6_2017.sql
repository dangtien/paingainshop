...
insert into HangHoa(MaHH,TenHH,NhomHH,GiaBan,GiaNhap,ThuocTinh,SoLuong,DonViTinh,MaNCC,GhiChu) values
	('SP000001',N'Áo ba lỗ bản to',N'Áo ba lỗ',220000,130000,'',30,N'cái','NC000005',''),
	('SP000002',N'Áo thun Nike Pro Combat',N'Áo thun',230000,150000,'',50,N'cái','NC000006',''),
	('SP000003',N'Quần short Nike dù',N'Quần short',180000,100000,'',50,N'cái','NC000006',''),
	('SP000004',N'Găng tay Muscletech',N'Găng tay',320000,180000,'',40,N'đôi','NC000008',''),
	('SP000005',N'Cuốn cổ tay Muscltech',N'Cuốn cổ tay',200000,90000,'',45,N'đôi','NC000008',''),
	('SP000006',N'Túi thể thao 3 ngăn Adidas',N'Túi xách',350000,150000,'',30,N'cái','NC000006',''),
	('SP000007',N'Bình nước PowerTrain',N'Bình nước',150000,70000,'',25,N'chiếc','NC000009',''),
	('SP000008',N'Cuốn gối Muscletech',N'Phụ kiện khác',450000,200000,'',20,N'đôi','NC000008',''),
	('SP000009',N'Dây Lifting Muscletech',N'Phụ kiện khác',150000,80000,'',40,N'đôi','NC000008',''),
	('SP000010',N'Đai lưng Muscletech',N'Đai lưng',550000,250000,'',10,N'cái','NC000008','');
